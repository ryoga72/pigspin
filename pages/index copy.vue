<template>
    <NuxtLayout name="default">
        <!-- <section v-if="$device.isDesktop">
            <div>
                <video autoplay="autoplay" loop="loop" muted defualtMuted playsinline class="w-[100%]">
                    <source src="../assets/video_1.mp4" type="video/mp4" />
                </video>
            </div>
        </section> -->

        <section class="image-zoom-container">

            <video autoplay="autoplay" loop="loop" muted defualtMuted playsinline class="zoom-image" alt="Image to Zoom"
                :class="{ 'zoomed': isZoomed }" :style="{ transform: `scale(${zoomFactor})` }">
                <source src="../assets/video_1.mp4" type="video/mp4" />
            </video>
        </section>
        ...
        <div class="w-full">
            <div class="container py-2 mx-auto lg:w-[60%] md:w-[100%] p-10">
                    ...
                    <div class="grid grid-cols-4 gap-4 mt-4">
                        <div class="justify-self-center ">
                            <div class="flex items-center justify-center ">
                                <img src="../assets/serviec-1.png" class="rounded-lg w-[150px]" />
                            </div>
                        ...
                        <div class="justify-self-center">
                            <div class="flex items-center justify-center ">
                                <img src="../assets/serviec-2.png" class="rounded-lg w-[150px]" />
                        ...
                        <div class="justify-self-center">
                            <div class="flex items-center justify-center ">
                                <img src="../assets/serviec-3.png" class="rounded-lg w-[150px]" />
                        ...
                        <div class="justify-self-center">
                            <div class="flex items-center justify-center ">
                                <img src="../assets/serviec-4.png" class="rounded-lg w-[150px]" />
                ...
                <div class="mt-10 post">
                    ...
                    <div class="flex justify-center mt-4">
                        <button
                            class="rounded-full btn btn-outline bg-gradient-to-b from-yellow-100 via-[#f0c373] to-[#f0c373] text-black">บทความทั้งหมด</button>
                    </div>
                </div>
            </div>
        </div>
...
const handleScroll = () => {
    ...
    const imageOffset = image.value.offsetTop;
    isZoomed.value = scrollTop > imageOffset;

    if (isZoomed.value) {
        zoomFactor.value = 0.405; // Zoom out
    } else {
...
onMounted(() => {
    image.value = document.querySelector('.zoom-image');
...
.image-zoom-container {
    ...
    /* background-image: url("../assets/bgvideo.webp"); */
    width: 100%;
    overflow: hidden;
    position: relative;
    max-width: 100%;
